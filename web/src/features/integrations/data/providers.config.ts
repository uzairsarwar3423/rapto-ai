...
export const INTEGRATION_PROVIDERS: readonly IntegrationProviderConfig[] = [
  {
    ...
    icon: "slack",
    consentCopy: "Rapto will post summaries, action items, and alerts to Slack channels you specify. We never read messages from your workspace.",
  ...
  },
  {
    ...
    icon: "jira",
    consentCopy: "Rapto will create Jira tickets from action items and update them when marked complete. We never read other Jira issues.",
  ...
  },
  {
    ...
    icon: "linear",
    consentCopy: "Rapto will create issues in your Linear teams and update their status. We only access teams you select.",
  ...
  },
  {
    ...
    icon: "notion",
    consentCopy: "Rapto will create pages and sync databases in your Notion workspace. We only read databases you explicitly share with us.",
    docsUrl: "/docs/integrations/notion",
    disconnectConsequence: "Disconnecting Notion will prevent Rapto from cataloging meeting transcripts or syncing action lists into your Notion database.",
  ...
  },
  {
    ...
    consentCopy: "Rapto will scan your upcoming calendar events to automatically identify and join scheduled video calls. We never modify your calendar.",
    docsUrl: "/docs/integrations/google-calendar",
    disconnectConsequence: "Disconnecting Google Calendar will prevent the Rapto bot from automatically joining and transcribing your scheduled calls.",
  ...
  },
  {
    ...
    consentCopy: "Rapto will scan your upcoming Outlook calendar events to automatically identify and join scheduled video calls. We never modify your calendar.",
    docsUrl: "/docs/integrations/outlook-calendar",
    disconnectConsequence: "Disconnecting Outlook Calendar will prevent the Rapto bot from automatically joining and transcribing your scheduled calls.",
